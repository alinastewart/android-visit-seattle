...
public class MallsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seattlePlaces.add(new Place("Pacific Rim Center", "(425) 888 333", R.drawable.mall_pacific_rim_center));
        seattlePlaces.add(new Place("Pike Place Market", "(425) 666 555", R.drawable.mall_pike_place_market));
